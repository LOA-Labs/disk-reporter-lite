...
var startServer = function () {
    var app = express();
    var port = 4445;
    app.get('/disk', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var diskSpace, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, check_disk_space_1["default"])(req.query.disk)];
                case 1:
                    diskSpace = _a.sent();
    ...
    app.listen(port, function () {
        console.log("\n=========\nDisk reporter listing on port ".concat(port));
    });
};
startServer();
